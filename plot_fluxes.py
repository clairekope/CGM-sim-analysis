...
ax[0,0].set_ylabel(r"$\dot{M}_\mathrm{cold}(r)\ \ [\mathrm{M_\odot}\ yr^{-1}]$", fontsize="large")
ax[1,0].set_ylabel(r"$\dot{M}_\mathrm{cool}(r)\ \ [\mathrm{M_\odot}\ yr^{-1}]$", fontsize="large")
ax[2,0].set_ylabel(r"$\dot{M}_\mathrm{warm}(r)\ \ [\mathrm{M_\odot}\ yr^{-1}]$", fontsize="large")
ax[3,0].set_ylabel(r"$\dot{M}_\mathrm{hot}(r)\ \ [\mathrm{M_\odot}\ yr^{-1}]$", fontsize="large")
ax[4,0].set_ylabel(r"$\dot{M}_\mathrm{total}(r)\ \ [\mathrm{M_\odot}\ yr^{-1}]$", fontsize="large")
...
for i in range(3):
    ax[i].set_ylabel("$\dot{M}(r)\ \ [\mathrm{M_\odot\ yr^{-1}}]$")
